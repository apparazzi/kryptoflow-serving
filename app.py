...
from backend.api.predict.endpoints.client import ns as prediction_namespace
from backend.api.historical.endpoints.client import ns as historic_namespace
from backend.api.test import ns as test_namespace
from flask_socketio import SocketIO
from backend.ws.handler import AvroListener, thread
